...
class Firelog
{
	...
	{
		$system 	= Less_Benchmark::get('system');
		$flags 		= Less_Benchmark::get('system.flags');
		$check		= Less_Benchmark::get('system.check_files');
	...
	public static function display()
	{
		...
		{
			foreach(Less_Log::$log as $type => $value)
			{
	...
	private static function _file($file,$name = false)
	{
		...
		$table[] = array('Compressed Size', Less_Utils::readable_size($contents));
		$table[] = array('Gzipped Size', Less_Utils::readable_size($gzipped));
		FB::table($name,$table);
	}
}