<?php
/**
 * This file acts as the front controller for brightCSS.
 * If you plan on using Less anywhere else, you
...
if(isset($_GET['f']))
{
	...
	/**
	 * Various options can be set in the URL. Less
	...
	/**
	 * Whether to output the CSS, or return the result of Less
	 */
	$display = true;
	...
	if(isset($_GET['d']))
	{
		...
		{
			$files[$key] = bCSS_Utils::join_path($_GET['d'],$file);
		}
	}
	 ...
	 */
	$result = Less::parse($files,$config,$options,$display);
