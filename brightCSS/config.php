 ...
 *
 * If the cache lifetime has expired, Less will refresh the flags and
 ...
 * need to change this unless you are moving folders around. If you're calling Less
 * from another class or script, you'll still need to set this. You can make it relative,
 * an absolute file path, or even relative to the document root and Less
 ...
 * this to any other folder, it just isn't usually necessary as Less
 * can take care of everything internally.
 *
 * You will probably set this if you're using Less within another framework.
 */
$config['cache'] = './cache/';
 ...
 *
 * Less can cache it's flags, config values and more to save on 
 ...
 *
 * Setting this to false means that Less will check to see if the original
 ...
 * Use PHP compression
 *
 * If you don't want to use the .htaccess to gzip your files, you can have Less
